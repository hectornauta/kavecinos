...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnPredecirPunto = QtWidgets.QPushButton(self.centralwidget)
        self.btnPredecirPunto.setGeometry(QtCore.QRect(610, 10, 151, 31))
        self.btnPredecirPunto.setObjectName("btnPredecirPunto")
        self.linePuntoX = QtWidgets.QLineEdit(self.centralwidget)
        self.linePuntoX.setGeometry(QtCore.QRect(490, 10, 51, 31))
        self.linePuntoX.setObjectName("linePuntoX")
        self.linePuntoY = QtWidgets.QLineEdit(self.centralwidget)
        self.linePuntoY.setGeometry(QtCore.QRect(550, 10, 51, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnPredecirPunto.setText(_translate("MainWindow", "Predecir"))
